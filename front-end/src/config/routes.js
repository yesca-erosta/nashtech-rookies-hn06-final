const routes = {
    ...
    createnewAssignment: {
        path: '/manageassignment/createnewassignment',
        name: 'Manage Assignment > Create New Assignment',
    },
    editAssignment: { path: '/manageassignment/editassignment', name: 'Manage Assignment > Edit Assignment' },
    notFound: { path: '*' },
};
