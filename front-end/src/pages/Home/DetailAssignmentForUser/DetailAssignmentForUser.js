...
export const DetailAssignmentForUser = ({ showDetail, assignmentDetail, handleCloseDetail }) => {
    return (
        <Modal show={showDetail} onHide={handleCloseDetail}>
            <Modal.Header>
                <Modal.Title className={styles.modalTitle}>Detailed Assignment Information</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Row>
                ...
                <Row className="mt-3">
                    ...
                    <Col>
                        <Form.Control
                            size="sm"
                            type="text"
                            placeholder={convertStatetoStr(assignmentDetail.state)}
                            readOnly
                            disabled
                        />
                    </Col>
