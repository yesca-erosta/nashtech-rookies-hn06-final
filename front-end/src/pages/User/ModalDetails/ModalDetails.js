...
export const ModalDetails = ({ userDetails, handleClose, show }) => {
    return (
        <Modal show={show} onHide={handleClose}>
                ...
                <Row className="mt-3">
                    ...
                    <Col>
                        <Form.Control
                            size="sm"
                            type="text"
                            placeholder={dateStrToStr(userDetails.dateOfBirth)}
                            readOnly
                            disabled
                        />
                    </Col>
                ...
                <Row className="mt-3">
                    ...
                    <Col>
                        <Form.Control
                            size="sm"
                            type="text"
                            placeholder={dateStrToStr(userDetails.joinedDate)}
                            readOnly
                            disabled
                        />
                    </Col>
            ...
            <Modal.Footer>
                <Button variant="outline-secondary" size="sm" className={styles.btnCancel} onClick={handleClose}>
                    Cancel
                </Button>
            </Modal.Footer>
        </Modal>
